...
function exp_harita_1rule0_eval_expression(context) {
    // 
...
function exp_harita_1rule1_eval_expression(context) {
    // ybizden = 'Evet'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ybizden')  == 'Evet');
    } else {
        return (feature.get('ybizden')  == 'Evet');
    }
}
...
function exp_harita_1rule2_eval_expression(context) {
    // ortahasar = 'Evet'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('ortahasar')  == 'Evet');
    } else {
        return (feature.get('ortahasar')  == 'Evet');
    }
}